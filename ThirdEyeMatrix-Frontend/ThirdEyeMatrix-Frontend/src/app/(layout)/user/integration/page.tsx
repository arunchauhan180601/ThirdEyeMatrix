  ...
  return (
    ...
    {/* Download Section */}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 p-4">
        <div className="flex flex-col items-center bg-[#dbfce7] justify-center p-4 border border-[#aff2c9] rounded-lg shadow-sm">
   ...
   {/* Products Section */}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 p-4">
        <div className="flex flex-col items-center justify-center p-4 border border-[#ffd3aa] bg-[#ffedd4] rounded-lg shadow-sm">
        ...
        <div className="flex flex-col items-center justify-center bg-[#daedff] p-4 border border-[#b9dbfe] rounded-lg shadow-sm">
        ...
        <div className="flex flex-col items-center justify-center bg-[#fef9c2] p-4 border border-[#fbeb9b] rounded-lg shadow-sm">
        ...
        <div className="flex flex-col items-center justify-center p-4 border border-[#e5c8ff] bg-[#f3e8ff] rounded-lg shadow-sm">
        ...
        <div className="flex flex-col items-center justify-center bg-[#ffe0e1] p-4 border border-[#ffcdcf] rounded-lg shadow-sm">
        ...
        <div className="flex flex-col items-center justify-center bg-[#fdf2f8] p-4 border border-[#fbcfe8] rounded-lg shadow-sm">
        ...
        <div className="flex flex-col items-center justify-center bg-[#eef2ff] p-4 border border-[#c7d2fe] rounded-lg shadow-sm">
